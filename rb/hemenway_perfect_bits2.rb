...
# debugger
  ...
  count = count_perms_in_mid_range_noninclusive(prev_num1_base, num2) - prev_permutations_count(num1)
...
# p perfect_bits(30000, 32768)# == 651 => 650
...
p perfect_bits(9223372036854775807, 9223372036854775815)#==2 => 786208248064212964
num1 = 9223372036854775807
num2 = 9223372036854775815
p count_perms_in_initial_range_noninclusive(num1, num2)
p count_perms_in_mid_range_noninclusive(num1, num2)
p count_perms_in_final_range_inclusive(num1, num2)

p '---initial+mid range, non-inclusive---'
p perfect_bits(10, 32)# == 7
p perfect_bits(30, 64)# == 13
p perfect_bits(100, 256)# == 45 => 46

p '---mid+final range, inclusive---'
p perfect_bits(16, 39)#==7
p perfect_bits(16, 40)#==7 => 6
p perfect_bits(16, 43)#==8
p perfect_bits(16, 44)#==8 => 7
p perfect_bits(16, 45)#==9
p perfect_bits(16, 46)#==10
p perfect_bits(16, 47)#==10 =>9
p perfect_bits(16, 140)#==40 =>39


# p next_perfect_bit(9223372036854775808)
