...
def ice_cream_shop(flavors, favorite)
  ...
  midx = flavors.length / 2
  left_flavors = flavors.take(midx)
  right_flavors = flavors.drop(midx)

  ice_cream_shop(left_flavors, favorite) || ice_cream_shop(right_flavors, favorite)
end
